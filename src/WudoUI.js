    ...
    <div className="App">
      <div className="navbar">
        ...
        <div className="icons">
          ...
          <i className="fas fa-shopping-cart shopping-cart-icon"></i>{/* Add the new class here */}
        </div>
      </div>
        ...
        <div className="content-left">
          <div className="image-section">
            ...
            <div className="rotate-line"> 
              <img src="https://github.com/eungobs/E-commerce/blob/master/49-492739_circle-arrow-png%201%20(1).jpg?raw=true" alt="rotate-line-image"/>
            </div>
